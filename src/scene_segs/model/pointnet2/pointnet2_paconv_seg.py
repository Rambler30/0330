...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='/mnt/mountA/cwy/pointcloud/scene_seg/config/GDUT/school_pointnet2_paconv_cuda.yaml',
                        help='config file')
    parser.add_argument('opts', help='see config/s3dis/s3dis_pointnet2_paconv.yaml for all options', default=None,
