...
def get_parser():
    ...
    #                     default='/mnt/mountA/cwy/pointcloud/scene_seg/config/GDUT/school_pointnet2_paconv_cuda.yaml', 
    #                     help='config file')
    # parser.add_argument('--config', type=str, default='/mnt/mountA/cwy/pointcloud/scene_seg/config/GRSS/grss_pointnet2_paconv_cuda.yaml', help='config file')
    parser.add_argument('--config', type=str,
                        default='/mnt/mountA/cwy/pointcloud/scene_seg/config/s3dis/s3dis_pointnet2_paconv_cuda.yaml',
                        help='config file')
...
def get_grss_parser():
    ...
    #                     help='config file')
    parser.add_argument('--config', type=str, 
                        default='/mnt/mountA/cwy/pointcloud/scene_seg/config/GRSS/grss_pointnet2_paconv_cuda.yaml', 
                        help='config file')
    # parser.add_argument('--config', type=str,
    #                     default='/mnt/mountA/cwy/pointcloud/scene_seg/config/s3dis/s3dis_pointnet2_paconv_cuda.yaml',
    #                     help='config file')
